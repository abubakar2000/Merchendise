...
export default class Footer extends Component {
    render() {
        return (
            <div style={{ paddingTop: '10pt', paddingBottom: '10pt', backgroundColor: '#1e2733', }}>
                <div style={{ display: 'flex', justifyContent: 'center', }}>
                    <img src='/assets/twitter2.png' style={{ height: '30pt', margin: '5pt' }} />
                    <img src='/assets/facebook2.png' style={{ height: '30pt', margin: '5pt' }} />
                    <img src='/assets/insta2.png' style={{ height: '30pt', margin: '5pt' }} />
                </div>
                <div style={{ display: 'flex', justifyContent: 'center',color:'white' }}>
                    <div style={{margin:'5pt'}}>Refund Policy</div>
                    <div style={{margin:'5pt'}}>Support</div>
                </div>
                <div style={{ display: 'flex', justifyContent: 'center',color:'white' }}>
                    <div style={{margin:'5pt'}}>Terms of Use</div>
                    <div style={{margin:'5pt'}}>Privacy Policy</div>
                </div>
                <div style={{ display: 'flex', justifyContent: 'center',color:'gray' }}>
                    <div>© 2022 Clossum.com</div>
                </div>
            </div>
